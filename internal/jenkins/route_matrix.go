	...
	return RouteMatrixDocument{
		...
		Routes: []RouteEntry{
			...
			},
			{
				...
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_stop_build", "jenkins_interrupt_build"},
				AuthSchemeNotes: "Crumb + RO gate; MUT-003/MUT-010 mode=stop; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go", "internal/jenkins/requestclass.go"},
			},
			{
				ID:              "term_build",
				PathPattern:     "/job/{segments}/{n}/term",
				PathPrefixes:    []string{"/term"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_interrupt_build"},
				AuthSchemeNotes: "Crumb + RO; MUT-010 mode=term; preview/confirm; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go", "internal/tools/mutation_power_tools.go"},
			},
			{
				ID:              "kill_build",
				PathPattern:     "/job/{segments}/{n}/kill",
				PathPrefixes:    []string{"/kill"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_interrupt_build"},
				AuthSchemeNotes: "Crumb + RO; MUT-010 mode=kill; preview/confirm; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go", "internal/tools/mutation_power_tools.go"},
			},
			{
				ID:              "job_enable",
				PathPattern:     "/job/{segments}/enable",
				PathPrefixes:    []string{"/enable"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_set_job_buildable"},
				AuthSchemeNotes: "Crumb + RO; MUT-013 enable; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go"},
			},
			{
				ID:              "job_disable",
				PathPattern:     "/job/{segments}/disable",
				PathPrefixes:    []string{"/disable"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_set_job_buildable"},
				AuthSchemeNotes: "Crumb + RO; MUT-013 disable; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go"},
			},
			{
				ID:              "toggle_keep_forever",
				PathPattern:     "/job/{segments}/{n}/toggleLogKeepForever",
				PathPrefixes:    []string{"/togglelogkeepforever"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_set_build_keep_forever"},
				AuthSchemeNotes: "Crumb + RO; MUT-014; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go"},
			},
			{
				ID:              "submit_description",
				PathPattern:     "/job/{segments}/{n}/submitDescription",
				PathPrefixes:    []string{"/submitdescription"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_set_build_description"},
				AuthSchemeNotes: "Crumb + RO; MUT-014 length-capped; no POST auto-retry.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go"},
			},
			{
				ID:              "pipeline_replay",
				PathPattern:     "/job/{segments}/{n}/replay/rebuild",
				PathPrefixes:    []string{"/replay"},
				Methods:         []string{"POST"},
				Class:           RouteClassMutation,
				Tools:           []string{"jenkins_replay_pipeline"},
				AuthSchemeNotes: "Crumb + RO; MUT-012 same-definition only; no script-edit default.",
				FixtureCovered:  true,
				SourceFiles:     []string{"internal/jenkins/client_mutations.go"},
			},
			{
