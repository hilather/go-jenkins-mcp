...
// Wave 46 / KD-008 + MCP-001 conformance (Track D):
//   - Hard-assert Wave 44/45 Done* HTTP MaxBody still 4 MiB default / 16 MiB absolute
//   - (Wave 46 Track A MaxJSON is jenkins-layer; Streamable HTTP body stays 4/16)

// TestWave46_HTTPMaxBodyBytes_Hard hard-asserts Wave 44 Track C / Wave 45
// retention: default 4 MiB, absolute 16 MiB fail-closed, env name, resolve
// precedence. Must remain true after Wave 46 parallel tracks merge.
func TestWave46_HTTPMaxBodyBytes_Hard(t *testing.T) {
	t.Parallel()
