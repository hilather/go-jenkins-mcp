...
// Wave 44 / KD-008 + MCP-001 conformance:
//   - Hard-assert DefaultMaxBodyBytes + AbsoluteMaxBodyBytes + ResolveHTTPMaxBodyBytes

// TestWave44_HTTPMaxBodyBytes_Hard hard-asserts Wave 44 Track C Done*:
// default 4 MiB, absolute 16 MiB fail-closed, env name, resolve precedence.
func TestWave44_HTTPMaxBodyBytes_Hard(t *testing.T) {
	t.Parallel()
