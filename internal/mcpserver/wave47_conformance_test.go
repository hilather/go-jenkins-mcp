...
// Wave 47 / KD-008 + MCP-001 conformance (Track D):
//   - Hard-assert Wave 44/45/46 Done* HTTP MaxBody still 4 MiB default / 16 MiB absolute
//   - (Wave 47 Track A MaxRetries is jenkins-layer; Streamable HTTP body stays 4/16)

// TestWave47_HTTPMaxBodyBytes_Hard hard-asserts Wave 44 Track C / Wave 45–46
// retention: default 4 MiB, absolute 16 MiB fail-closed, env name, resolve
// precedence. Must remain true after Wave 47 parallel tracks merge.
func TestWave47_HTTPMaxBodyBytes_Hard(t *testing.T) {
	t.Parallel()
