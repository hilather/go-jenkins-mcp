...
// Wave 51 / KD-008 + MCP-001 conformance (Track D):
//   - Hard-assert Wave 44/45–50 Done* HTTP MaxBody still 4 MiB default / 16 MiB absolute
//   - (Wave 51 feature tracks A/B/C live in jenkins/tools/diagnostics; Streamable
//     HTTP body stays 4/16)

// TestWave51_HTTPMaxBodyBytes_Hard hard-asserts Wave 44 Track C / Wave 45–50
// retention: default 4 MiB, absolute 16 MiB fail-closed, env name, resolve
// precedence. Must remain true after Wave 51 parallel tracks merge.
func TestWave51_HTTPMaxBodyBytes_Hard(t *testing.T) {
	t.Parallel()
