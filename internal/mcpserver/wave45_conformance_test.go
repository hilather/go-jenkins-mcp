...
// Wave 45 / KD-008 + MCP-001 conformance (Track D):
//   - Hard-assert Wave 44 Done* ResolveHTTPMaxBodyBytes + AbsoluteMax 16 MiB

// TestWave45_HTTPMaxBodyBytes_Hard hard-asserts Wave 44 Track C Done*:
// default 4 MiB, absolute 16 MiB fail-closed, env name, resolve precedence.
func TestWave45_HTTPMaxBodyBytes_Hard(t *testing.T) {
	t.Parallel()
