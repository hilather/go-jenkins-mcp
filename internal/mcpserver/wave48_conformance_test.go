...
// Wave 48 / KD-008 + MCP-001 conformance (Track D):
//   - Hard-assert Wave 44/45/46/47 Done* HTTP MaxBody still 4 MiB default / 16 MiB absolute
//   - (Wave 48 Track A circuit resolve is jenkins-layer; Streamable HTTP body stays 4/16)

// TestWave48_HTTPMaxBodyBytes_Hard hard-asserts Wave 44 Track C / Wave 45–47
// retention: default 4 MiB, absolute 16 MiB fail-closed, env name, resolve
// precedence. Must remain true after Wave 48 parallel tracks merge.
func TestWave48_HTTPMaxBodyBytes_Hard(t *testing.T) {
	t.Parallel()
