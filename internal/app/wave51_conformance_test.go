...
// Wave 51 / ARC-007 cache maintenance conformance (Track D):
//   - Hard-assert Wave 49 Done* ResolveMaintenanceInterval absolute fail-closed
//     resolve (default 5m, min 30s, absolute 1h) — retention through Wave 51

// TestWave51_Wave49Done_ResolveMaintenanceInterval_Hard hard-asserts Wave 49
...
// invalid. Must remain true after Wave 51 parallel tracks merge.
func TestWave51_Wave49Done_ResolveMaintenanceInterval_Hard(t *testing.T) {
	t.Parallel()
