...
func checkGatewayStatus(getenv func(string) string) Check {
	...
	details["progressive_consent_process_local_metadata_store"] = pc.ProcessLocalConsentMetadataStore
	details["progressive_consent_multi_replica"] = pc.MultiReplicaConsentCorrelation
