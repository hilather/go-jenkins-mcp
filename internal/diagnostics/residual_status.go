...
const ResidualStatusHonestyNote = "unified gateway residual snapshot (env/static honesty only): offline Mode A/B/C foundations Done*; live Entra / jwt-auth-filter / AgentCore / multi-replica HA residual — never production GO from this surface; see docs/gateway/live-pin-blockers.md"
