...
Companion: [tool-contracts.md](tool-contracts.md) · [user guide](user/README.md) · optional Entra jwt-rs lab (not a pin): [testing/entra-jwt-rs-lab.md](testing/entra-jwt-rs-lab.md) · full-stack Docker sibling (not a qualification gate; [AGENTS.md](../AGENTS.md#full-stack--multi-protocol-docker-lab-sibling-repo)): [hilather/mcp-integration-lab](https://github.com/hilather/mcp-integration-lab)  
...
| implemented pilot | `admin_rbac_list_bindings`, `admin_rbac_put_binding`, `admin_rbac_delete_binding` | UI-011 / POL-006; fleet SoT = signed config |
...
to signed enterprise bundles remains residual (validate path implemented).
