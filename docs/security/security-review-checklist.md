...
2. **Live Jenkins + IdP lab** — jwt-auth-filter, reverse-proxy, OAuth anti-fallback matrix (TST-001 live residual); offline RS matrix is implemented only for classifiers.
