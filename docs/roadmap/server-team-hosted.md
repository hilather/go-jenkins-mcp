...
| Streamable HTTP hardened multi-user | **Partial** (loopback + shared-secret; HOST-002 matrix docs) | Live path-prefix pin; mTLS production | GWY-004, MCP-001 residual, **HOST-001**, **HOST-002** | P0 | KD-008 residual today |
