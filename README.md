...
| Admin | Local admin console + opt-in `admin_*` MCP | [docs/admin/](docs/admin/) · [v0.8.0 notes](https://github.com/hilather/go-jenkins-mcp/blob/v0.8.0/docs/release/RELEASE_NOTES_v0.8.0.md) |
